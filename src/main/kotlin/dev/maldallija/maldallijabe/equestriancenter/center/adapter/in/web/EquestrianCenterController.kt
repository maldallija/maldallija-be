package dev.maldallija.maldallijabe.equestriancenter.center.adapter.`in`.web

import dev.maldallija.maldallijabe.common.adapter.`in`.web.ErrorResponse
import dev.maldallija.maldallijabe.equestriancenter.center.adapter.`in`.web.dto.EquestrianCenterDetailResponse
import dev.maldallija.maldallijabe.equestriancenter.center.adapter.`in`.web.dto.EquestrianCenterListResponse
import dev.maldallija.maldallijabe.equestriancenter.center.adapter.`in`.web.dto.UpdateEquestrianCenterRequest
import dev.maldallija.maldallijabe.equestriancenter.center.application.port.`in`.GetEquestrianCenterUseCase
import dev.maldallija.maldallijabe.equestriancenter.center.application.port.`in`.GetEquestrianCentersUseCase
import dev.maldallija.maldallijabe.equestriancenter.center.application.port.`in`.UpdateEquestrianCenterUseCase
